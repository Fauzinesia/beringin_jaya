          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Pegawai Pemerintah Desa Beringin Jaya</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <a href="inputbagian.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Pegawai</button></a>
                  <a href="cetak_laporanbagian.php"><button type="button" class="btn btn-success"><i class="fa fa-print"></i> Cetak Laporan Bagian</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href= cetak_bagian.php?id_bagian='.$data['id_bagian'].' target="_blank"><button type="button" title="Cetak Laporan" class="btn btn-info btn-xs"><i class="fa fa-print"></i></button></a>
