...
<html lang="en">
  <head>
    ...
    <title>SISTEM INFORMASI MANAJEMEN ARSIP DIGITAL </title>
                    ...
                    <div class="row">
                      <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">     
                            ...
                            <br><br> 
                            <center><h1><b>Master Data</b></h1></center>
                            <br><br> 
                        </div>
                      </div>
                      ...
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <p>Telah Diarsipkan</p>
                                ...
                                <?php include '../koneksi/koneksi.php';
                                $sql3		= "SELECT * FROM tb_asetkantor";  
                                $query3  	= mysqli_query($db, $sql3);
                                $jumlah3   = mysqli_num_rows($query3);
                                  ?>
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i class="fa fa-building (alias)"></i>
                          </div>
                          ...
                          <p>Telah Diarsipkan</p>
                                ...
                                <?php include '../koneksi/koneksi.php';
                                $sql3		= "SELECT * FROM tb_asetdesa";  
                                $query3  	= mysqli_query($db, $sql3);
                                $jumlah3   = mysqli_num_rows($query3);
                                  ?>
                      <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i class="fa fa-align-justify (alias)"></i>
                          </div>
                          <div class="count"><?php echo "$jumlah3" ?></div>
