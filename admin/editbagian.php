                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_editbagian.php" method="post" enctype="multipart/form-data" id="demo-form2" name="formupdate" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['nik_bagian'];?>" type="text" onkeyup="validAngka(this)" id="nik_bagian" name="nik_bagian" required="required" maxlength="16" placeholder="Masukkan NIK" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
