                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><?php echo $data['nomor_suratmasuk']; ?></td>
                                <td align="center"><?php echo $data['kepada_suratmasuk']; ?></td>
                                <td align="center"><?php echo $data['perihal_suratmasuk']; ?></td>
                                <td align="center"><?php echo $data['tanggalmasuk_suratmasuk']; ?></td>
                                <td align="center"><?php echo $data['pengirim']; ?></td>
                                <td align="center"><?php echo $data['tanggalsurat_suratmasuk']; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
