<?php
	...
	$nik_bagian		   	        = mysqli_real_escape_string($db,$_POST['nik_bagian']);
	...
	if (!($nama_bagian=='') and !($username_admin_bagian=='') and !($password_bagian =='') and !($nama_lengkap=='') and !($tgl_lahir =='') and !($alamat=='') and !($nik_bagian=='') and
		...
		$sql = "INSERT INTO tb_bagian(nama_bagian, username_admin_bagian, password_bagian, nama_lengkap, tanggal_lahir_bagian, alamat, nik_bagian, gambar)
				values ('$nama_bagian', '$username_admin_bagian', '$password_bagian', '$nama_lengkap', '$tgl_lahir', '$alamat', '$nik_bagian', '$nama_baru')";
