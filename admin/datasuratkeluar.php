          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Surat Keluar</small></h2>
                    <div class="clearfix"></div>
                    </div>
                  <a href="inputsuratkeluar.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Surat Keluar</button></a>
                  <a href="cetak_laporansuratkeluar.php"><button type="button" class="btn btn-success"><i class="fa fa-print"></i> Cetak Laporan Surat Keluar</button></a>
                  </form>
                  <div class="x_content">
                  <div class="x_content">
                              <?php
