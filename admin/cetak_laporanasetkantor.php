                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr style="background-color: darkgrey" height="30px">
                            ...
                            <th style="text-align: center; font-size: 18px;">Penanggung Jawab</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><?php echo $data['nama_asetkantor']; ?></td>
                                <td align="center"><?php echo $data['jumlah_asetkantor']; ?></td>
                                <td align="center"><?php echo $data['tanggal_asetkantor']; ?></td>
                                <td align="center"><?php echo $data['nama_bagian']; ?></td>
                                <td align="center"><?php echo $data['tahun_asetkantor']; ?></td>
                                <td align="center"><?php echo $data['kondisi_asetkantor']; ?></td>
                                <td align="center">Rp.<?php echo number_format($data['harga_asetkantor'], 0,',', '.'); ?></td>
                            </tr>
