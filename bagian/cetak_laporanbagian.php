                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr style="background-color: darkgrey" height="30px">
                            ...
                            <th style="text-align: center; font-size: 18px;">Jabatan</th>
                            <th style="text-align: center; font-size: 18px;">Tanggal Lahir</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><?php echo $data['nik_bagian']; ?></td>
                                <td align="center"><?php echo $data['nama_bagian']; ?></td>
                                <td align="center"><?php echo $data['tanggal_lahir_bagian']; ?></td>
