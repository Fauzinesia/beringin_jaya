            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <a href="inputasetkantor.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah aset Kantor</button></a>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=editasetkantor.php?id_asetkantor='.$data['id_asetkantor'].' ><button type="button" title="Edit" class="btn btn-success btn-xs"><i class="fa  fa-edit"></i></button></a>
                              <a onclick="return konfirmasi()" href="proses/proses_hapusasetkantor.php?id_asetkantor='.$data['id_asetkantor'].'"><button type="button" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a></td>
                              </tr>';
                            }
                            ?>
                      </tbody>
